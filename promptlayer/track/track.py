...
def prompt(
    ...
    if not isinstance(prompt_input_variables, dict):
        raise _exceptions.ValidationError("Please provide a dictionary of input variables.", response=None, body=None)
...
def metadata(api_key: str, base_url: str, throw_on_error: bool, request_id, metadata):
    if not isinstance(metadata, dict):
        raise _exceptions.ValidationError("Please provide a dictionary of metadata.", response=None, body=None)
...
def score(api_key: str, base_url: str, throw_on_error: bool, request_id, score, score_name=None):
    if not isinstance(score, int):
        raise _exceptions.ValidationError("Please provide a int score.", response=None, body=None)
    if not isinstance(score_name, str) and score_name is not None:
        raise _exceptions.ValidationError("Please provide a string as score name.", response=None, body=None)
    if score < 0 or score > 100:
        raise _exceptions.ValidationError("Please provide a score between 0 and 100.", response=None, body=None)
...
async def ascore(api_key: str, base_url: str, throw_on_error: bool, request_id, score, score_name=None):
    if not isinstance(score, int):
        raise _exceptions.ValidationError("Please provide an integer score.", response=None, body=None)
    if not isinstance(score_name, str) and score_name is not None:
        raise _exceptions.ValidationError("Please provide a string as score name.", response=None, body=None)
    if score < 0 or score > 100:
        raise _exceptions.ValidationError("Please provide a score between 0 and 100.", response=None, body=None)
